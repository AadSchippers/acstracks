...
class Track(models.Model):
    ...
    publictrack_start_pointindex = models.DecimalField(max_digits=6, decimal_places=0, default=0)
    publictrack_end_pointindex = models.DecimalField(max_digits=6, decimal_places=0, default=0)
