...
urlpatterns = [
    ...
    path(
        '<str:date_start>,<str:date_end>,<str:order_selected>,<str:profile_filter>,<int:intermediate_points_selected>',
        views.track_list,
        name='track_list'
        ),
    path('track/<int:pk>', views.track_detail, name='track_detail'),
    path(
        'track/<int:pk>,<str:date_start>,<str:date_end>,<str:order_selected>,<str:profile_filter>,<int:intermediate_points_selected>',
        views.track_detail,
        name='track_detail'
        ),
    path('preference/', views.process_preferences, name='preference'),
    path(
        'preference/,<str:date_start>,<str:date_end>,<str:order_selected>,<str:profile_filter>,<int:intermediate_points_selected>',
        views.process_preferences,
        name='preference'
        ),
    path('cleanup/', views.cleanup, name='cleanup'),
    path('statistics/<str:statistics_type>', views.show_statistics, name='show_statistics'),
